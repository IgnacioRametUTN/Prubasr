...
@CrossOrigin("*")
public class ArticuloManufacturadoController extends ArticulosControllerImpl<ArticuloManufacturado, ArticuloManufacturadoDto,Long, ArticuloManufacturadoFacadeImpl> {
